...
namespace DeviceOAuth2
{
    ...
    public sealed class DeviceOAuth : IDeviceOAuth2, IDeviceOAuth2Stepwise
    {
        ...
        /// <summary>
        /// Starts the authorization flow. If a non-null auth Token is passed, and it has a refresh token, the access token will be generated by refreshing. Otherwise
        /// if token is null or has no <see cref="TokenInfo.RefreshToken"/>, a new authorization flow will be started.
        /// </summary>
        ...
        /// <returns>True if the auth token is stil valid</returns>
